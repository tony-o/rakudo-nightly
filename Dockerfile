...
#RUN cd /usr/local/src/rakudo; perl Configure.pl            --gen-nqp --backends=jvm  --prefix=/usr/local && make && make install
#RUN cd /usr/local/src/rakudo; perl Configure.pl            --gen-nqp --backends=js   --prefix=/usr/local && make && make install
